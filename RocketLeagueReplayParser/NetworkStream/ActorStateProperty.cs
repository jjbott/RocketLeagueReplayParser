...
namespace RocketLeagueReplayParser.NetworkStream
{
    public class ActorStateProperty
    {
        ...
        public static ActorStateProperty Deserialize(IClassNetCache classMap, string[] objectIndexToName, int replayVersion, BitReader br)
        {
            ...
            switch (asp.PropertyName)
            {
                ...
                case "ProjectX.GRI_X:Reservations":
                    asp.Data.Add(Reservation.Deserialize(replayVersion, br));
                    asp.MarkComplete();
                    break;
        ...
        public void Serialize(int maxPropId, int replayVersion, BitWriter bw)
        {
            ...
            switch (PropertyName)
            {
                ...
                case "ProjectX.GRI_X:GameServerID":
                    ...
                    break;
                case "ProjectX.GRI_X:Reservations":
                    ((Reservation)Data[0]).Serialize(replayVersion, bw);
                    break;
                case "TAGame.Ball_TA:ReplicatedExplosionData":
                    bw.Write((bool)Data[0]);
                    bw.Write((UInt32)Data[1]);
