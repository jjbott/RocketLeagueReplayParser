...
Supports all replay files created by Rocket League version 1.37 (released 2017-09-28) and earlier.  If it doesnt, please create an issue with a link to the problematic replay and I'll get it fixed up.
