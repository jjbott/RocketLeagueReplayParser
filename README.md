...
Supports all replay files created by Rocket League version 1.43 (released 2018-04-03) and earlier.  If it doesnt, please create an issue with a link to the problematic replay and I'll get it fixed up.
