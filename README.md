...
Supports all replay files created by Rocket League version 1.35 (released 2017-07-05) and earlier.  If it doesnt, please create an issue with a link to the problematic replay and I'll get it fixed up.
